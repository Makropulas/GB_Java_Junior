...
public class QueryBuilder {
    ...
    public String buildSelectQuery(Class<?> clazz, UUID primaryKey) {
        return queryFromTableWhereId("SELECT *", clazz, primaryKey);
    }
    ...
    public String buildDeleteQuery(Class<?> clazz, UUID primaryKey) {
        return queryFromTableWhereId("DELETE", clazz, primaryKey);
    }

    public String queryFromTableWhereId(String startOfQuery, Class<?> clazz, UUID primaryKey) {
        StringBuilder query = new StringBuilder(startOfQuery);
        query.append(" FROM ");
